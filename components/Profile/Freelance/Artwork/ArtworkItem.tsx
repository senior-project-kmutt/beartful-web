        ...
        <ArtworkImageContainer>
          ...
          {showDropdown &&
            <Dropdown ref={dropdownRef}>
              <ul className="py-2">
                <li>
                  <button style={{ width: '100%', height: '100%', textAlign: 'left' }} onClick={() => router.push(`${process.env.NEXT_PUBLIC_BASEPATH}/profile/artwork/edit?artworkId=${_id}`)}>แก้ไขผลงาน</button>
                </li>
                <li>
